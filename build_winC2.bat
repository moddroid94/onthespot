...
if exist ffbin_win\ffmpeg.exe (
    ...
    pyinstaller --onefile --noconsole --noconfirm --hidden-import="zeroconf._utils.ipaddress" --hidden-import="zeroconf._handlers.answers" --add-data="src/onthespot/resources/*.qss;onthespot/resources" --add-data="src/onthespot/gui/qtui/*.ui;onthespot/gui/qtui" --add-data="src/onthespot/resources/*.png;onthespot/resources" --add-binary="ffbin_win/*.exe;onthespot/bin/ffmpeg" --paths="src/onthespot" --name="onthespot_win_ffm" --icon="src/onthespot/resources/icon.png" src\portable.py
) else (
    echo  =^> Building to use ffmpeg binary from system...
    pyinstaller --onefile --noconsole --noconfirm --hidden-import="zeroconf._utils.ipaddress" --hidden-import="zeroconf._handlers.answers" --add-data="src/onthespot/resources/*.qss;onthespot/resources" --add-data="src/onthespot/gui/qtui/*.ui;onthespot/gui/qtui" --add-data="src/onthespot/resources/*.png;onthespot/resources" --paths="src/onthespot" --name="onthespot_win" --icon="src/onthespot/resources/icon.png" src\portable.py
)
echo  =^> Cleaning..
