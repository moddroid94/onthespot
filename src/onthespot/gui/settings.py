...
def load_config(self):
    ...
    self.inp_download_play_btn.setChecked(config.get("download_play_btn"))
    self.inp_download_save_btn.setChecked(config.get("download_save_btn"))
    self.inp_download_queue_btn.setChecked(config.get("download_queue_btn"))
...
def save_config(self):
    ...
    config.set_('download_play_btn', self.inp_download_play_btn.isChecked())
    config.set_('download_save_btn', self.inp_download_save_btn.isChecked())
    config.set_('download_queue_btn', self.inp_download_queue_btn.isChecked())
